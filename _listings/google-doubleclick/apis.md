...
- name: Google Doubleclick API Get URL Channels
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/channels/master/_listings/google-doubleclick/accounts-accountid-adclients-adclientid-urlchannels-get.md
x-common:
